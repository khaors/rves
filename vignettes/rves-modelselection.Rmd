...
```{r simple_plot_results3,fig.height=4,fig.width=6,fig.align='center'}
plot(ves1, type = "ves", main = "3 Layers, Model Selection (BIC)")
```
...
res.cmplx.rss <- calibrate_step_nls(ves.cmplx, max.layers = 10, 
                                    iterations = 30, 
                                    ireport = 5,
                                    select.measure = "rss")
```
...
```{r complex_stepwise_aic,echo=TRUE,eval=FALSE}
ves.cmplx.aic <- ves.cmplx
res.cmplx.aic <- calibrate_step_nls(ves.cmplx.aic, max.layers = 10, 
                                    iterations = 30, 
                                    ireport = 5,
                                    select.measure = "aic")
```
